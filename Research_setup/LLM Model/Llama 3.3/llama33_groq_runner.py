...
// **Intent:** Run Llama 3.3 remotely on Groq using prompts.jsonl (JSON message arrays) and write generations JSONL (pure I/O runner).
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ap = argparse.ArgumentParser(
        description="Run Llama 3.3 on Groq using prompts.jsonl and write generations JSONL (pure I/O runner)."
    )
