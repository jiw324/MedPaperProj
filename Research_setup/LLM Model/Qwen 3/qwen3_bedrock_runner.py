...
// **Intent:** Run Qwen 3 remotely on Groq using their Python SDK and write generations JSONL (pure I/O runner).
...
def main(argv: Optional[List[str]] = None) -> int:
    ap = argparse.ArgumentParser(
        description="Run Qwen 3 on Groq via their Python SDK using prompts.jsonl (pure I/O runner)."
    )
