...
# **Intent:** Evaluate Meditron-7B on small subsets of medical QA datasets (PubMedQA/MedMCQA).
...
"""
Meditron-7B Experiment: Medical QA (subset)
===========================================
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Subset evaluation for Meditron-7B (Transformers).",
