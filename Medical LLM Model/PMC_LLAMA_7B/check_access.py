...
# **Intent:** Verify Hugging Face authentication + access for PMC_LLAMA_7B without downloading large weights.
...
"""
PMC_LLAMA_7B Access Checker
===========================

Models (examples):
- https://huggingface.co/wanglab/PMC_LLAMA_7B

Usage (PowerShell):
  cd "...\Medical LLM Model\PMC_LLAMA_7B"
