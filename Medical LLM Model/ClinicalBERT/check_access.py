...
# **Intent:** Verify Hugging Face authentication + access for ClinicalBERT without downloading large weights.
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Check HF access to ClinicalBERT by downloading a tiny file only.")
