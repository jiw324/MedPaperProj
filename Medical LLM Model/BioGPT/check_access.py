...
# **Intent:** Verify Hugging Face authentication + access for BioGPT without downloading large weights.
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Check HF access to BioGPT by downloading a tiny file only.")
    parser.add_argument("--model", default="microsoft/BioGPT-Large", help="HF model id to check access for.")
    parser.add_argument(
        "--file",
        default="config.json",
