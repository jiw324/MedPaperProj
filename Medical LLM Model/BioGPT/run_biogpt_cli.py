...
# **Intent:** Provide a lightweight CLI/REPL to run BioGPT for causal text generation.
# **Optimization:** Uses `device_map=auto` by default; optional dtype override; keeps defaults small.
...
Usage (PowerShell):
  cd "...\Medical LLM Model\BioGPT"
  $env:HF_TOKEN="hf_..."   # if gated/private; do NOT paste token into chat
  python run_biogpt_cli.py --model microsoft/BioGPT-Large --prompt "Hello"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="BioGPT CLI for causal text generation.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument("--model", default="microsoft/BioGPT-Large", help="HF model id to load.")
